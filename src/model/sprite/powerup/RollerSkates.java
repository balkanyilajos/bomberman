...
public class RollerSkates extends PowerUp {
    ...
    public RollerSkates(GameModel model, Point2D areaPoint, Dimension areaSize, Point2D imagePoint, Dimension imageSize) {
        super(model, new Area(new Ellipse2D.Double(areaPoint.getX()+areaSize.width*0.125, areaPoint.getY()+areaSize.height*0.125, areaSize.width*0.75, areaSize.height*0.75)),
            imagePoint, areaPoint, imageSize, "src/data/picture/powerup/boot.png",30);
    }
