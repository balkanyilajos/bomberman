...
public class GamePanel extends JPanel {
    ...
    public GamePanel(GameModel gameModel) {
        ...
        try {
            background = ImageIO.read(new File(GeneralPath.getPath() + "/picture/background.jpg"));
        } catch (IOException e) {
        ...
        Dimension maximumBoardSize = new Dimension((int) (screenSize.width * contentPercentage),
                (int) (screenSize.height * contentPercentage - menuPanelHeight));
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawImage(background, backgroundPoint.x, backgroundPoint.y, backgroundSize.width, backgroundSize.height,
                this);
    }
