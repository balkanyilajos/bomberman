...
public class BombBooster extends PowerUp {
    ...
    public BombBooster(GameModel model, Point2D areaPoint, Dimension areaSize, Point2D imagePoint,
            Dimension imageSize) {
        super(model,
                ...
                imagePoint, areaPoint, imageSize, GeneralPath.getPath() + "/picture/powerup/bomb.png", 30);
    }

    @Override
    public void effect(Player player) {
        this.player = player;
        player.setBombBooster(this);
    }
