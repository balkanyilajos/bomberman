...
public class BlastBooster extends PowerUp {
    ...
    public BlastBooster(GameModel model, Point2D areaPoint, Dimension areaSize, Point2D imagePoint,
            Dimension imageSize) {
        super(model,
                ...
                imagePoint, areaPoint, imageSize, GeneralPath.getPath() + "/picture/powerup/flame.png", 30);
    }
